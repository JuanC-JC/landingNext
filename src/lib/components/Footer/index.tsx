    ...
    <FooterStyled>
      <div className="title">
        ...
        <div className="footer__icons">
          <a className="icon" target="_blank" href={whatsappUrl} aria-label="Contact us via us">
            <WhatsappIcon />
          </a>
          <a className="icon" target="_blank" href={linkedInurl} aria-label="go to vammo linkedin">
            <LinkedinIcon />
          </a>
        </div>
      </div>
